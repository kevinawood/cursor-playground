      ...
      <div class="transition-colors duration-200 px-3 sm:px-4 lg:px-6 border-b" :class="darkMode ? 'bg-[#111111] border-[#262626]' : 'bg-white border-gray-200'">
        <div class="flex items-center justify-between h-12 sm:h-16">
          ...
          <button
            ...
            :class="darkMode ? 'text-gray-500 hover:text-white hover:bg-white/10' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-100'"
          >
            ...
            <button
              ...
              :class="[
                ...
                showUnreadOnly
                  ...
                  : darkMode 
                    ? 'bg-[#1a1a1a] text-gray-300 hover:bg-[#222] border border-[#262626]' 
