...
ALIASES=(
    ...
    "alias rss-start-backend='$SCRIPT_DIR/start-backend.sh'"
    "alias rss-start-frontend='$SCRIPT_DIR/start-frontend.sh'"
...
echo "   rss-start-backend   - Start only backend server"
echo "   rss-start-frontend  - Start only frontend server"
echo "   rss-backend         - Start only backend server (alternative)"
echo "   rss-frontend        - Start only frontend server (alternative)"
